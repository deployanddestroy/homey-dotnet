namespace Homey.Api.Modules.Identity;
...
public static class CustomIdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapCustomIdentityApi<TUser>(this IEndpointRouteBuilder endpoints, RouteGroupBuilder? routeGroup = null)
        where TUser : class, new()
    {
        ...
        // Ensure route group is not null
